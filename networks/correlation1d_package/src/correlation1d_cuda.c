...
int Correlation1D_forward_cuda(THCudaTensor *input1, THCudaTensor *input2, THCudaTensor *rInput1, THCudaTensor *rInput2, THCudaTensor *output,
                       int pad_size,
                       int kernel_size,
                       ...
                       int corr_type_multiply)
{
  ...
  int success = 0;
  success = Correlation1D_forward_cuda_kernel(THCudaTensor_data(state, output),
...
int Correlation1D_backward_cuda(THCudaTensor *input1, THCudaTensor *input2, THCudaTensor *rInput1, THCudaTensor *rInput2, THCudaTensor *gradOutput,
                       ...
                       int corr_type_multiply)
{
  ...
  int batchSize = input1->size[0];
  int nInputChannels = input1->size[1];
  int paddedInputHeight = input1->size[2];
