...
from networks import DispFullNet

from networks.submodules import *
'Parameter count = 162,518,834'

class DispNetF(nn.Module):
    def __init__(self,args,batchNorm=False):
        super(DispNetF, self).__init__()
        self.batchNorm = batchNorm
        self.network = DispFullNet.DispFullNet(args,batchNorm=self.batchNorm)
